...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border/40 bg-gradient-to-br from-slate-900 to-blue-900 text-white">
      <div className={`container ${isLandingPage ? 'py-8' : 'py-6'}`}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
          {/* Company Info */}
          <div className={`${isLandingPage ? 'space-y-3' : 'space-y-2'}`}>
            <div className={`${isLandingPage ? 'w-40' : 'w-32'} h-auto`}>
          ...
          {/* Quick Links */}
          <div className={`${isLandingPage ? 'space-y-3' : 'space-y-2'}`}>
            <h4 className={`font-semibold ${isLandingPage ? 'text-lg' : 'text-base'}`}>Quick Links</h4>
            <ul className={`${isLandingPage ? 'space-y-3' : 'space-y-2'} text-sm`}>
              <li>
          ...
          {/* Support & Contact */}
          <div className={`${isLandingPage ? 'space-y-3' : 'space-y-2'}`}>
            <h4 className={`font-semibold ${isLandingPage ? 'text-lg' : 'text-base'}`}>Support</h4>
            <ul className={`${isLandingPage ? 'space-y-3' : 'space-y-2'} text-sm text-gray-300`}>
              <li>
        ...
        {/* Copyright */}
        <div className={`${isLandingPage ? 'mt-6 pt-4' : 'mt-4 pt-3'} border-t border-gray-700 text-center text-sm text-gray-400`}>
