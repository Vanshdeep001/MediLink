...
export default function DoctorChatDocPage() {
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground">Chat with patients in real-time as a backup to video calls</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg">
            <ChatDoc
              currentUserId={doctorName || `doctor_${Date.now()}`}
              currentUserName={doctorName || 'Doctor'}
              currentUserType="doctor"
              onVideoCall={(patientId, patientName) => {
                toast({
              ...
              onPhoneCall={(patientId, patientName) => {
                toast({
